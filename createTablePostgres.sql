...
CREATE TABLE Contatto(
    idContatto int serial NOT NULL ,
    ...
    email1 varchar(255),
    email2 varchar(255),
    CONSTRAINT PK_idContatto PRIMARY KEY (idContatto)
);
...
CREATE TABLE Portafoglio(
    idPortafoglio int serial NOT NULL ,
    idUtente int NOT NULL,
    dataInserimento int NOT NULL,
    CONSTRAINT PK_idPortafoglio PRIMARY KEY (idPortafoglio)
    FOREIGN KEY (idUtente) REFERENCES Utente(idUtente)
);

CREATE TABLE TipoCliente (
    idTipoCliente int serial NOT NULL ,
    nome varchar(255),
    CONSTRAINT PK_idTipoCliente PRIMARY KEY (idTipoCliente)
);

CREATE TABLE Presidio (
    idPresidio int serial NOT NULL ,
    nome varchar(255),
    CONSTRAINT PK_idPresidio PRIMARY KEY (idPresidio)
);

CREATE TABLE Comune (
    idComune int serial NOT NULL ,
    nome varchar(255),
    sigla varchar(255),
    CONSTRAINT PK_idComune PRIMARY KEY (idComune)
);


CREATE TABLE Cliente(
    idCliente int serial NOT NULL ,
    idUtente int NOT NULL,
...
CREATE TABLE Regione(
    idRegione int serial NOT NULL ,
    nome varchar(255),
    CONSTRAINT PK_idRegione PRIMARY KEY (idRegione)
);

CREATE TABLE Categoria(
    idCategoria int serial NOT NULL ,
    nome varchar(255),
...
CREATE TABLE Trattativa(
    idTrattativa int serial NOT NULL ,
    idUtente int,
    idCliente int,
    ...
    CONSTRAINT PK_idTrattativa PRIMARY KEY (idTrattativa)
    FOREIGN KEY (idUtente) REFERENCES Utente(idUtente),
...
CREATE TABLE Appuntamento(
    idAppuntamento int serial NOT NULL ,
    ...
    dataApp date,
    CONSTRAINT PK_idAppuntamento PRIMARY KEY (idAppuntamento)
